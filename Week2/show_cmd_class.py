...
"""
Ex 3: telnetlib (optional - challenge question)

    Convert the code that I wrote here (https://github.com/ktbyers/pynet/blob/master/pyth_ans_ecourse/class2/ex2_telnetlib.py)
     to a class-based solution (i.e. convert over from functions to a class with methods).
"""
